      ...
      <div className="bg-[#6683d2] w-full max-w-screen-xl min-h-screen relative flex flex-col items-center justify-center">
        ...
        <div className="w-full bg-[#B5D1E1] py-6 px-8 flex items-center shadow-md fixed top-0 left-0 right-0 rounded-b-[28px]">
          ...
          <div className="flex flex-wrap gap-4 mt-4 md:mt-0">
            ...
            <button className="bg-gray-300 px-6 py-2 rounded-2xl text-lg md:text-xl font-Inknut_Antiqua-Regular" onClick={() => handleNavigate("/studying-group")}>
              Group Learning
            </button>
            <button className="bg-gray-300 px-6 py-2 rounded-2xl text-lg md:text-xl font-Inknut_Antiqua-Regular" onClick={() => handleNavigate("/resultstracking")}>
